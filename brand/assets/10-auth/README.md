...
This folder contains the dedicated account/login visual mini-library.
...
These files contain no mutable authentication copy and can be used as decorative atmosphere behind live HTML/CSS:
