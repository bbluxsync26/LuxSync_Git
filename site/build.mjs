...
const SLOGAN = 'Where Luxury Lives Intelligently';
...
const catalog = {
  families: [
    ['Foundation & Connectivity', 'Hubs, controllers, bridges, and network-support products selected around a reliable SmartThings-first foundation.'],
    ['Entry & Access', 'Smart locks, entry controllers, contact sensors, and compatible doorbell or entry-awareness products.'],
    ['Lighting & Ambience', 'Smart bulbs, switches, dimmers, plugs, accent lighting, outdoor lighting, and validated shades.'],
    ['Comfort & Climate', 'Thermostats, environmental sensors, and compatible climate-control accessories.'],
    ['Property Awareness', 'Cameras, motion and presence sensors, door and window sensors, and property-status technology.'],
    ['Water Protection', 'Leak sensors, water sensors, shut-off products, and freeze or temperature awareness where appropriate.'],
    ['Energy & Power', 'Smart plugs, outlets, energy-monitoring products, lighting controls, and climate controls.'],
    ['Entertainment & Ambience', 'Smart televisions, speakers, streaming devices, and scene-ready lighting and shade products.'],
    ['Cleaning & Convenience', 'Robotic cleaning products, selected smart appliances, and convenience devices that fit the LuxSync ecosystem.'],
    ['Outdoor Living', 'Outdoor lighting, plugs, awareness sensors, and validated entertainment products.']
  ].map(([name, description]) => ({ name, description, status: 'Planning Product Family' })),
  bundles: [
    { name: 'STR Property Automation Kit', status: 'Planning Bundle', note: 'Exact contents and public pricing require Commerce Plus validation.' },
    { name: 'STR Guest Welcome & Keyless Entry Bundle', status: 'Planning Bundle', note: 'Exact contents and public pricing require Commerce Plus validation.' },
    { name: 'Smart Sleep Nursery Kit', status: 'Planning Bundle', note: 'Exact contents and public pricing require Commerce Plus validation.' },
    { name: 'Senior Independent Safety Bundle', status: 'Planning Bundle', note: 'Pricing remains unresolved and is not published.' }
  ],
  experiences: [
    'Welcome Home', 'Effortless Departure', 'Goodnight', 'Gentle Morning', 'Intelligent Evening', 'Night Path',
    'Climate Intelligence', 'Energy Intelligence', 'Water Watch', 'Away', 'Protect', 'Property Pulse', 'Vacation Mode',
    'Cinema', 'Entertain', 'Relax', 'Accessible Living', 'Guest Ready', 'Turnover', 'STR Property Pulse',
    'STR Water Watch', 'STR Energy Intelligence', 'Intelligent Opening', 'Intelligent Closing', 'Business Energy Intelligence',
...
const hero = `<section class="hero"><div class="hero-aura" aria-hidden="true"></div><div class="hero-inner"><div class="hero-copy"><p class="eyebrow">Intelligent living, curated</p><h1>${SLOGAN}</h1><p class="hero-lede">Luxury smart-home technology designed for modern living, with curated hardware and thoughtful automation that bring comfort, control, and confidence to every space.</p><div class="button-row"><a class="button" href="/find-my-luxsync-solution/">Find My LuxSync Solution</a><a class="button button-secondary" href="/shop/">Shop Smart Home</a><a class="text-link" href="/guides/">Get the ROI Guide →</a></div></div><div class="hero-visual" aria-label="LuxSync intelligent living concept"><div class="orbital-shell"><img src="/assets/LuxSync_Logo_Orb.png" alt=""><span class="orbit orbit-one"></span><span class="orbit orbit-two"></span><span class="orbit orbit-three"></span></div><div class="hero-stat"><span>Outcome first</span><strong>Lifestyle → Experience → Intelligence → Technology</strong></div></div></div></section>`;
...
<section class="section"><div class="section-heading"><p class="eyebrow">Meet the Founders</p><h2>Technology strategy meets customer-centered operations.</h2></div><div class="founder-grid"><article class="founder-card"><div class="founder-monogram">BB</div><h3>Bridgette Beardsley</h3><p class="role">Co-Founder & Chief Technology and Strategy Officer</p><p>Bridgette is the visionary behind LuxSync, guiding technology, strategy, governance, and the digital customer experience with a focus on replacing technical complexity with trusted curation.</p></article><article class="founder-card"><div class="founder-monogram">SB</div><h3>Sheldon Bardol</h3><p class="role">Co-Founder & Chief Customer and Operations Officer</p><p>Sheldon leads product curation, supplier relationships, customer engagement, and operational execution with a focus on a dependable, personal, and simple experience.</p></article></div><div class="section-cta"><a class="text-link" href="/about/">Meet LuxSync leadership →</a></div></section>
...
function aboutPage() {
  return `<section class="page-hero"><div><p class="eyebrow">About LuxSync</p><h1>Luxury is confidence.</h1><p>LuxSync was created to simplify smart-home technology without sacrificing elegance, quality, or confidence.</p></div></section><section class="section"><div class="prose"><p>Too often, smart living begins with a wall of technical specifications, disconnected products, and too many decisions. LuxSync takes a different approach. We begin with the way a customer wants a home, rental property, or professional space to feel and function, then organize compatible products and guidance around that outcome.</p><p>Our mission is to help customers create environments that are safer, smarter, and more comfortable through trusted curation, thoughtful automation, and technology that belongs naturally in the space.</p><blockquote>We believe luxury is not complexity. <strong>Luxury is confidence.</strong></blockquote></div></section><section class="section section-dark"><div class="section-heading"><p class="eyebrow">Leadership</p><h2>Two disciplines. One customer experience.</h2></div><div class="founder-grid"><article class="founder-card"><div class="founder-monogram">BB</div><h3>Bridgette Beardsley</h3><p class="role">Co-Founder & Chief Technology and Strategy Officer</p><p>Bridgette Beardsley is the Co-Founder and visionary behind LuxSync. Drawing on more than three decades of enterprise technology and operations leadership, she guides the company's technology, strategy, governance, and digital customer experience. Her vision is to make intelligent living feel elegant and effortless by replacing technical complexity with trusted curation, thoughtful automation, and solutions designed around how people want to live.</p></article><article class="founder-card"><div class="founder-monogram">SB</div><h3>Sheldon Bardol</h3><p class="role">Co-Founder & Chief Customer and Operations Officer</p><p>Sheldon Bardol is the Co-Founder and Chief Customer and Operations Officer of LuxSync. With a practical background in financial operations, customer resolution, and relationship management, he leads product curation, supplier partnerships, customer engagement, and operational execution. His focus is creating a LuxSync experience that feels personal, dependable, and simple from the first recommendation through every customer interaction.</p></article></div></section><section class="section"><div class="section-heading"><p class="eyebrow">Our Promise</p><h2>Quiet technology. Clear guidance.</h2></div><div class="promise-grid"><div>Begin with the customer's desired experience.</div><div>Make compatibility and limitations understandable.</div><div>Curate with purpose rather than overwhelm with choice.</div><div>Keep technology quiet, useful, and at home in the environment.</div></div></section>`;
}
