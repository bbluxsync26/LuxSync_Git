...
function header(activeRoute) {
  ...
  return `<header class="site-header"><div class="header-inner"><div class="header-start"><button class="nav-toggle" type="button" aria-label="Open menu" aria-expanded="false" aria-controls="main-nav"><svg viewBox="0 0 28 28" aria-hidden="true"><path d="M6 7h19M4 14h19M2 21h19"/></svg></button><a class="utility-icon ls-home" href="/" aria-label="LS — Home"><img src="/assets/luxsync-orb.png" alt=""></a></div><a class="brand-link" href="/" aria-label="LuxSync home"><img src="/assets/luxsync-horizontal.png" alt="LuxSync"></a><div class="property-nav" aria-label="Property solutions"><a class="button" href="/solutions/commercial/">Commercial</a><a class="button" href="/solutions/residential/">Residential</a></div><nav id="main-nav" class="main-nav" aria-label="Primary navigation">${links}</nav>${headerControls()}</div></header>`;
}
