...
function header(activeRoute) {
  ...
  return `<header class="site-header"><div class="header-inner"><button class="nav-toggle" type="button" aria-expanded="false" aria-controls="main-nav"><img src="/assets/luxsync-orb.png" alt="Menu"></button><a class="brand-link" href="/" aria-label="LuxSync home"><img src="/assets/luxsync-horizontal.png" alt="LuxSync"></a><nav id="main-nav" class="main-nav" aria-label="Primary navigation">${links}</nav><div class="header-actions"><a class="nav-link account-nav" href="/account/">Account</a><a class="nav-link cart-nav" href="/shop/#planning-cart">Cart <span class="cart-count" data-cart-count>0</span></a><a class="button button-small header-cta" href="/find-my-luxsync-solution/">LuxSync Concierge</a></div></div></header>`;
}
