...
function header(activeRoute) {
  const nav = [
    ...
    ['/guides/', 'Guides'], ['/about/', 'About'], ['/account/', 'Account'], ['/faqs/', 'FAQs'], ['/contact/', 'Contact']
  ];
