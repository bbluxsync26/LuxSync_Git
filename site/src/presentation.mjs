...
export function homeOverview({HOME, SLOGAN, card}) {
  const featured = [
    ['Short-Term Rentals','A welcoming arrival. Easier turnovers. Confidence from afar.','/solutions/short-term-rentals/','rental'],
    ['Seniors & Caregivers','Gentler routines and everyday ease, designed with dignity.','/solutions/aging-in-place/','care'],
    ['Smart Office & Property','Spaces ready for the workday, with comfort built in.','/solutions/commercial-offices/','commercial'],
    ['Intentional Families','A home that moves naturally with your family’s day.','/solutions/residential/','residential'],
    ['Busy Professionals','Thoughtful arrival, departure, and energy-conscious routines.','/solutions/residential/','energy']
  ];
  ...
  <section class="section featured-section" id="featured-solutions"><div class="section-heading"><p class="eyebrow">Featured Solutions</p><h2>Find your kind of intelligent living.</h2></div><div class="card-grid card-grid-five">${featured.map(args=>card(...args)).join('')}</div><a class="text-link section-more" href="/solutions/">Explore all solutions →</a></section>
