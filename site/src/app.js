import {changeCart} from '/store-client.js';
...
function initBlueprint() {
  ...
  if (!blueprint) {
    root.innerHTML = `<div class="empty-state"><h2>Your Blueprint begins with the Concierge.</h2><p>Tell LuxSync about your space, priorities, routines, and existing technology to create a personalized intelligent-living direction.</p><a class="button" href="/find-my-luxsync-solution/">Find My LuxSync Solution</a></div>`;
    return;
  }
